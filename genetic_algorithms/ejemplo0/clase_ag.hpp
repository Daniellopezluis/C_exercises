...
class CLASECromosoma //contiene estructura que maneja datos codificados del modelo
{
    public:
        ...
        int             Longitud();                 //devuelve la longitud del cromosoma
        ...
        friend class    CLASEAGenetico;             // acceso. Tal vez hacer que esta clase HEREDE??
   private:
 ...
 ** ###########################################################################
 ** TODO:
 **     - Explicar que hace esta clase.
 **     - Mover a un archivo separado? (mayor limpieza en el código)
 ** ###########################################################################
 */
class CLASEAGenetico
{
    public:
        ...
        int                 FuncionEvaluacion(FuncionFitness_t);//fn que vincula con fn de evaluacion de cromosoma
    ...
    private:
        ...
        CLASECromosoma*     PoblacionA[AG_MAX_POBLACION];
        CLASECromosoma*     PoblacionB[AG_MAX_POBLACION];           //arreglo finito de apuntadores a cromosomas (individuos)
        int                 iTamanoPoblacionA;                      //dos poblaciones separadas, padres e hijos
        int                 iTamanoPoblacionB;                      //numero de individuos de cada poblacion
